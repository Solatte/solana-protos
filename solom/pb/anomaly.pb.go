...
type OHLCPriceAllWindow struct {
	...
	Price map[string]*OHLC `protobuf:"bytes,1,rep,name=price,proto3" json:"price,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *OHLCPriceAllWindow) GetPrice() map[string]*OHLC {
	if x != nil {
		return x.Price
	}
	return nil
...
var file_anomaly_proto_rawDesc = []byte{
	...
	0x02, 0x38, 0x01, 0x22, 0x57, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x4f, 0x48, 0x4c, 0x43, 0x50, 0x72,
	...
	0x52, 0x05, 0x61, 0x6d, 0x6d, 0x49, 0x64, 0x12, 0x23, 0x0a, 0x0d, 0x74, 0x69, 0x6d, 0x65, 0x5f,
	0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c,
	0x74, 0x69, 0x6d, 0x65, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x22, 0x97, 0x01, 0x0a,
	...
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x01, 0x52, 0x05, 0x63, 0x6c, 0x6f, 0x73, 0x65, 0x32, 0x9f,
	0x02, 0x0a, 0x07, 0x41, 0x6e, 0x6f, 0x6d, 0x61, 0x6c, 0x79, 0x12, 0x42, 0x0a, 0x09, 0x53, 0x75,
	...
	,
...
var file_anomaly_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_anomaly_proto_goTypes = []interface{}{
	...
	(*GetOHLCPriceAllWindowArgs)(nil),               // 10: solom.GetOHLCPriceAllWindowArgs
	(*OHLCPriceAllWindow)(nil),                      // 11: solom.OHLCPriceAllWindow
	(*OHLC)(nil),                                    // 12: solom.OHLC
	nil,                                             // 13: solom.PriceAllWindow.PriceEntry
	nil,                                             // 14: solom.ActionMap.VolumeEntry
	nil,                                             // 15: solom.VolumeAllWindow.VolumeEntry
	nil,                                             // 16: solom.OHLCPriceAllWindow.PriceEntry
}
var file_anomaly_proto_depIdxs = []int32{
	...
	13, // 3: solom.PriceAllWindow.price:type_name -> solom.PriceAllWindow.PriceEntry
	14, // 4: solom.ActionMap.volume:type_name -> solom.ActionMap.VolumeEntry
	15, // 5: solom.VolumeAllWindow.volume:type_name -> solom.VolumeAllWindow.VolumeEntry
	16, // 6: solom.OHLCPriceAllWindow.price:type_name -> solom.OHLCPriceAllWindow.PriceEntry
	8,  // 7: solom.VolumeAllWindow.VolumeEntry.value:type_name -> solom.ActionMap
	12, // 8: solom.OHLCPriceAllWindow.PriceEntry.value:type_name -> solom.OHLC
	...
	10, // 12: solom.Anomaly.GetOHLCPriceAllWindow:input_type -> solom.GetOHLCPriceAllWindowArgs
	5,  // 13: solom.Anomaly.Subscribe:output_type -> solom.SubscribeUpdate
	7,  // 14: solom.Anomaly.GetPriceAllWindow:output_type -> solom.PriceAllWindow
	9,  // 15: solom.Anomaly.GetVolumeAllWindow:output_type -> solom.VolumeAllWindow
	11, // 16: solom.Anomaly.GetOHLCPriceAllWindow:output_type -> solom.OHLCPriceAllWindow
